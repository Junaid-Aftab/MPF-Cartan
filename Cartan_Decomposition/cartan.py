...
#Local Imports
from Utility_Functions.PauliOps import commutatePauliString
import Utility_Functions.IO as IO
from Utility_Functions.IO import printlist, paulilabel
import Utility_Functions.verification
...
class FindParameters:
    ...
    * Efekan Kokcu
    ...
    def setCommutatorTables(self):
        ...
        self.comm_coefs = np.zeros((len(g_tuples),len(g_tuples)),dtype=np.complex128)
